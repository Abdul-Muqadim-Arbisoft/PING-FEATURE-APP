...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd forum_ping_app && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd forum_ping_app && i18n_tool generate

detect_changed_source_translations:
	cd forum_ping_app && i18n_tool changed
...
pull_translations:
	find forum_ping_app/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/repo_name/forum_ping_app/conf/locale:forum_ping_app/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd forum_ping_app && i18n_tool dummy
