...
"""
forum_ping_project documentation build configuration file.
...
#
# html_title = 'forum_ping_project v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'forum_ping_app'),
                os.path.join(root_path, 'forum_ping_app/migrations')])
