#!/usr/bin/env python
"""
Package metadata for forum_ping_app.
"""
import os
import re
import sys
...
VERSION = get_version('forum_ping_app', '__init__.py')
...
setup(
    ...
    packages=find_packages(
        include=['forum_ping_app', 'forum_ping_app.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "forum_ping_app = forum_ping_app.apps:ForumPingAppConfig",
        ],
        "cms.djangoapp": [
        ],
    },
